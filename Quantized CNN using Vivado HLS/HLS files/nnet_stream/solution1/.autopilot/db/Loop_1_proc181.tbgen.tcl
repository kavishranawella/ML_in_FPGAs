...
set C_modelName {Loop_1_proc181}
set C_modelType { void 0 }
set C_modelArgList {
	{ image_in_V_V int 8 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "image_in_V_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ image_in_V_V_din sc_out sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "image_in_V_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "image_in_V_V", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.input_activations_V_s_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	image_in_V_V { ap_fifo {  { image_in_V_V_din fifo_data 1 8 }  { image_in_V_V_full_n fifo_status 0 1 }  { image_in_V_V_write fifo_update 1 1 } } }
}

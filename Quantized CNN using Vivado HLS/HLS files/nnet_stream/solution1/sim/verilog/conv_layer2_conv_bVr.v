...
initial begin
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram0);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram1);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram2);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram3);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram4);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram5);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram6);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram7);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram8);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram9);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram10);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram11);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram12);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram13);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram14);
    $readmemh("./conv_layer2_conv_bVr_rom.dat", ram15);
end
...
conv_layer2_conv_bVr_rom conv_layer2_conv_bVr_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),

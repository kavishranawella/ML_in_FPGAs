...
AUTOPILOT_ROOT := /home/kavish/opt2/Xilinx/Vivado/2018.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /home/kavish/opt2/Xilinx/Vivado/2018.2/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/nnet_test.cpp_pre.cpp.tb.o : nnet_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nnet_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/nnet.cpp_pre.cpp.tb.o : nnet.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling nnet.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

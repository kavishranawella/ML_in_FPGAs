...
#ifndef __nnet_mac_muladd_3clv__HH__
#define __nnet_mac_muladd_3clv__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_3clv) {
    ...
    SC_CTOR(nnet_mac_muladd_3clv):  simcore_mac_15_U ("simcore_mac_15_U") {

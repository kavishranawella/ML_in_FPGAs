...
#ifndef __nnet_mac_muladd_4cgu__HH__
#define __nnet_mac_muladd_4cgu__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_4cgu) {
    ...
    SC_CTOR(nnet_mac_muladd_4cgu):  simcore_mac_10_U ("simcore_mac_10_U") {

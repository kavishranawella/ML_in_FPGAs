...
#ifndef __nnet_mac_muladd_4chv__HH__
#define __nnet_mac_muladd_4chv__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_4chv) {
    ...
    SC_CTOR(nnet_mac_muladd_4chv):  simcore_mac_11_U ("simcore_mac_11_U") {

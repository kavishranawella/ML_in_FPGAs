...
#ifndef __nnet_mac_muladd_8b4t__HH__
#define __nnet_mac_muladd_8b4t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_8b4t) {
    ...
    SC_CTOR(nnet_mac_muladd_8b4t):  simcore_mac_4_U ("simcore_mac_4_U") {

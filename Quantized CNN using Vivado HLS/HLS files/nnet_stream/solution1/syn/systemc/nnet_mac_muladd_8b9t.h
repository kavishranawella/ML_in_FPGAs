...
#ifndef __nnet_mac_muladd_8b9t__HH__
#define __nnet_mac_muladd_8b9t__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_8b9t) {
    ...
    SC_CTOR(nnet_mac_muladd_8b9t):  simcore_mac_7_U ("simcore_mac_7_U") {

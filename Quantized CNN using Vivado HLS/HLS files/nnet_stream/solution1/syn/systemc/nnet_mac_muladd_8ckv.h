...
#ifndef __nnet_mac_muladd_8ckv__HH__
#define __nnet_mac_muladd_8ckv__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mac_muladd_8ckv) {
    ...
    SC_CTOR(nnet_mac_muladd_8ckv):  simcore_mac_14_U ("simcore_mac_14_U") {

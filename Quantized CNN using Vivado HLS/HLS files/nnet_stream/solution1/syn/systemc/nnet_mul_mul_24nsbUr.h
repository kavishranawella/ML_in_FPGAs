...
#ifndef __nnet_mul_mul_24nsbUr__HH__
#define __nnet_mul_mul_24nsbUr__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_24nsbUr) {
    ...
    SC_CTOR(nnet_mul_mul_24nsbUr):  ACMP_smul_us_U ("ACMP_smul_us_U") {

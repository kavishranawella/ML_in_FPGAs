...
#ifndef __nnet_mul_mul_24s_b0s__HH__
#define __nnet_mul_mul_24s_b0s__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_24s_b0s) {
    ...
    SC_CTOR(nnet_mul_mul_24s_b0s):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {

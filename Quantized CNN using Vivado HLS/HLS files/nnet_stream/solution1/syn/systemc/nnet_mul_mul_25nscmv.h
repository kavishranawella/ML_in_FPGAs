...
#ifndef __nnet_mul_mul_25nscmv__HH__
#define __nnet_mul_mul_25nscmv__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(nnet_mul_mul_25nscmv) {
    ...
    SC_CTOR(nnet_mul_mul_25nscmv):  ACMP_smul_us_U ("ACMP_smul_us_U") {

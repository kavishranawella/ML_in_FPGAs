...
entity nnet is
port (
    fc3_out_V_V_din : OUT STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of nnet is 
    ...
    "nnet,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=13.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=13.981813,HLS_SYN_LAT=415220,HLS_SYN_TPT=415219,HLS_SYN_MEM=98,HLS_SYN_DSP=48,HLS_SYN_FF=8321,HLS_SYN_LUT=21368,HLS_VERSION=2018_2}";
    constant ap_const_lv32_0 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    constant ap_const_logic_0 : STD_LOGIC := '0';
    constant ap_const_logic_1 : STD_LOGIC := '1';

    signal Loop_1_proc181_U0_ap_start : STD_LOGIC;
    signal Loop_1_proc181_U0_ap_done : STD_LOGIC;
    signal Loop_1_proc181_U0_ap_continue : STD_LOGIC;
    signal Loop_1_proc181_U0_ap_idle : STD_LOGIC;
    signal Loop_1_proc181_U0_ap_ready : STD_LOGIC;
    signal Loop_1_proc181_U0_image_in_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal Loop_1_proc181_U0_image_in_V_V_write : STD_LOGIC;
    ...
    signal pool_layer1_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal conv_layer2_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal pool_layer2_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal fc_layer1_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal fc_layer2_U0_out_V_V_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal fc_layer3_U0_out_V_V_din : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    Loop_1_proc181_U0 : component Loop_1_proc181
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => Loop_1_proc181_U0_ap_start,
        ap_done => Loop_1_proc181_U0_ap_done,
        ap_continue => Loop_1_proc181_U0_ap_continue,
        ap_idle => Loop_1_proc181_U0_ap_idle,
        ap_ready => Loop_1_proc181_U0_ap_ready,
        image_in_V_V_din => Loop_1_proc181_U0_image_in_V_V_din,
        image_in_V_V_full_n => image_in_V_V_full_n,
        image_in_V_V_write => Loop_1_proc181_U0_image_in_V_V_write);
    ...
    port map (
        ...
        if_din => Loop_1_proc181_U0_image_in_V_V_din,
        if_full_n => image_in_V_V_full_n,
        if_write => Loop_1_proc181_U0_image_in_V_V_write,
        if_dout => image_in_V_V_dout,
        if_empty_n => image_in_V_V_empty_n,
        if_read => conv_layer1_U0_in_V_V_read);

    conv1_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    pool1_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    conv2_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    pool2_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fc1_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    fc2_out_V_V_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    Loop_1_proc181_U0_ap_start <= ap_start;
    Loop_1_proc181_U0_start_full_n <= ap_const_logic_1;
    Loop_1_proc181_U0_start_write <= ap_const_logic_0;
    ap_done <= fc_layer3_U0_ap_done;
    ap_idle <= (pool_layer2_U0_ap_idle and pool_layer1_U0_ap_idle and fc_layer3_U0_ap_idle and fc_layer2_U0_ap_idle and fc_layer1_U0_ap_idle and conv_layer2_U0_ap_idle and conv_layer1_U0_ap_idle and Loop_1_proc181_U0_ap_idle);
